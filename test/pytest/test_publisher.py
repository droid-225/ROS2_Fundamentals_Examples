...
Description:
  ...
  This script contains unit test for verifying the functionality of a minimal ROS 2 publisher.
...
def test_message_counter():
  ...
  Raises:
    AssertionError if the counter doesn't increment properly
  """
...
def test_message_content():
  ...
  This test verfies that the message string is properly formatted using an f-string
  with the current counter value.
  
  Raises:
    AssertionError if the message format doesn't match the expected output
  """
  rclpy.init()
